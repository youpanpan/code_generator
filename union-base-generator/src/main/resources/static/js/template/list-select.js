$(document).ready(function() {
    layui.use(['form', 'table','layer'], function() {
        ...
        table.render({
            ...
            where: {templateType: templateType, status: '1'},
            cellMinWidth: 80,
            height: 460,
        ...
        table.on('checkbox(listDataTable01Filter)', function(obj){
            if (obj.type === 'one') {
                if (obj.checked) {
                    selectedMap[obj.data.id] = obj.data.templateName;
                } else {
                ...
                if (obj.checked) {
                    ...
                    for (var i = 0; i < selectedArr.length; i++) {
                        selectedMap[selectedArr[i].id] = selectedArr[i].templateName;
                    }
                } else {
                    for (var i = 0; i < curPageList.length; i++) {
