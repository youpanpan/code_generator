    ...
    layui.use(['form', 'table','layer'], function() {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'contextName',  title: '上下文名称'},
                {field: 'className',  title: '全类名'},
            ]],
        ...
        table.on('checkbox(listDataTable01Filter)', function(obj){
            if (obj.type === 'one') {
                if (obj.checked) {
                    selectedMap[obj.data.id] = obj.data.contextName;
                } else {
                ...
                if (obj.checked) {
                    ...
                    for (var i = 0; i < selectedArr.length; i++) {
                        selectedMap[selectedArr[i].id] = selectedArr[i].contextName;
                    }
                } else {
                    for (var i = 0; i < curPageList.length; i++) {
